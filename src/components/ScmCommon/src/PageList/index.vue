<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup: (props) => {
       ...
       * 样式
       */
      const { prefixCls } = useDesign(props.prefixClass);
      ...
      function apiFun(dataSourceId: string, isExport = false) {
        ...
        return (searchForm = {}) => {
          ...
          return props.apiFn === undefined
            ? getDataBySysDataSourceId(dataSourceId, newForm)
            : props.apiFn(newForm);
        };
      }
